...
import { Search, UserCheck, ChevronRight, Mail, Phone, Clock, CheckCircle, AlertCircle, HelpCircle } from "lucide-react"
          ...
          <Card>
            <CardHeader>
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                  <CardTitle className="text-2xl">นักศึกษาในความดูแล</CardTitle>
                  <CardDescription>ดูรายชื่อและติดตามความคืบหน้าของนักศึกษาที่อยู่ในความดูแลของคุณ</CardDescription>
                </div>
                <div className="flex items-center gap-2">
                  ...
                  <Badge className="bg-blue-100 text-blue-800 hover:bg-blue-100">
                    กำลังฝึกงาน: {students.filter((s) => s.status === "active").length}
                  </Badge>
                </div>
              </div>
            </CardHeader>
                      ...
                      <table className="w-full caption-bottom text-sm">
                        <thead className="[&_tr]:border-b">
                          <tr className="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
                            <th className="h-12 px-4 text-left align-middle font-medium">รหัสนักศึกษา</th>
                            <th className="h-12 px-4 text-left align-middle font-medium">ชื่อ-นามสกุล</th>
                            <th className="h-12 px-4 text-left align-middle font-medium">ตำแหน่ง</th>
                            <th className="h-12 px-4 text-left align-middle font-medium">ระยะเวลา</th>
                            <th className="h-12 px-4 text-left align-middle font-medium">สถานะ</th>
                            <th className="h-12 px-4 text-left align-middle font-medium">การประเมิน</th>
                          ...
                          {filteredStudents.length > 0 ? (
                            filteredStudents.map((student) => (
                              ...
                              >
                                ...
                                <td className="p-4 align-middle">{student.position}</td>
                                <td className="p-4 align-middle">
                                ...
                                <td className="p-4 align-middle">
                                  ...
                                  <div className="text-xs mt-1 text-muted-foreground">{student.progress}% เสร็จสิ้น</div>
                                </td>
                                <td className="p-4 align-middle">
                ...
                <TabsContent value="cards" className="mt-0">
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {filteredStudents.length > 0 ? (
                        ...
                        <Card key={student.id} className="overflow-hidden">
                          ...
                          <CardContent className="p-4 pt-0">
                            <div className="space-y-3">
                              <div>
                                <div className="text-sm font-medium">ตำแหน่ง</div>
                                <div className="text-sm">{student.position}</div>
                              </div>
                              ...
                              <div>
                                <div className="text-sm font-medium mb-1">งานที่ได้รับมอบหมาย</div>
                      ...
                      <div className="col-span-full text-center py-8">ไม่พบข้อมูลนักศึกษาที่ตรงกับเงื่อนไขการค้นหา</div>
                    )}
                  </div>
                </TabsContent>
              </Tabs>
