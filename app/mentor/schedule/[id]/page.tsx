...
const appointments = [
  {
    ...
    time: "13:00 - 15:00",
    type: "onsite",
    location: "แหล่งฝึกงาน เทคโนโลยี จำกัด ห้องประชุม 3A",
    description:
    ...
    agenda: [
      ...
      "แหล่งฝึกให้ข้อมูลเกี่ยวกับการปฏิบัติงานของนักศึกษา (30 นาที)",
  ...
  },
  {
    ...
    agenda: [
      ...
      "แหล่งฝึกให้ข้อมูลและประเมินผลการฝึกงาน (30 นาที)",
  ...
  },
  {
    ...
    location: "แหล่งฝึกงาน เทคโนโลยี จำกัด ห้องประชุมใหญ่",
    description:
      "การปฐมนิเทศนักศึกษาฝึกงาน แนะนำแหล่งฝึกงาน กฎระเบียบ และแนวทางการปฏิบัติงาน",
    status: "completed",
    participants: [
      { name: "นายธนกร มั่นคง", role: "นักศึกษา" },
      { name: "นางสาวพิมพ์ชนก รักเรียน", role: "นักศึกษา" },
    ...
    agenda: [
      "แนะนำแหล่งฝึกงานและวัฒนธรรมองค์กร (30 นาที)",
    ...
    documents: [
      ...
      { name: "เอกสารแนะนำแหล่งฝึกงาน", type: "pdf" },
    ],
  },
  {
    id: "A007",
    ...
    time: "13:30 - 15:00",
    type: "onsite",
    location: "แหล่งฝึกงาน เทคโนโลยี จำกัด ห้องประชุม 2B",
    description:
