...
export default function Page() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setLoading(true);
      try {
        // Fetch calendars and companies data
        const [calendarResponse, companyResponse] = await Promise.all([
          fetch("/api/calendar"),
          fetch("/api/company"),
        ]);
    ...
    try {
      ...
      if (data.success) {
        toast({
          ...
          description: data.message || "บันทึกข้อมูลการชำระเงินสำเร็จ",
          variant: "success",
        });
          ...
          <div className="md:col-span-4">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div className="flex items-center gap-1 text-sm text-gray-500">
                ...
                <span className="text-gray-900">เพิ่มข้อมูลการชำระเงิน</span>
              </div>
            </div>
