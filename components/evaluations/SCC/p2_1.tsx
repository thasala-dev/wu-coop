...
const criteriaData = [
  {
    label: "p1",
    head: false,
    title: "1. การสืบค้นข้อมูล และการทบทวนวรรณกรรมอย่างเป็นระบบ",
  },
  { label: "p2", head: false, title: "2. อธิบายการพัฒนาโครงร่างงานวิจัยได้" },
  {
    label: "p3",
    head: false,
    title: "3. การวิเคราะห์ข้อมูล และการแปลผลการวิเคราะห์",
  },
  {
    label: "p4",
    head: false,
    title: "4. ความเข้าใจกระบวนการทำงานวิจัยด้านการประเมินเทคโนโลยีด้านสุขภาพ",
  },
  {
    label: "p5",
    head: false,
    title:
      "5. ความเข้าใจความสำคัญในการจัดประชุมผู้มีส่วนได้ส่วนเสีย เพื่อพิจารณากรอบแนวคิด วิธีการดำเนินงานวิจัยด้านการประเมินเทคโนโลยีด้านสุขภาพ",
  },
  {
    label: "p6",
    head: false,
    title:
      "6. ระบุได้ถึงบทบาท หน้าที่ และความรับผิดชอบของเภสัชกรและการทำงานร่วมกันกับวิชาชีพอื่นๆ ในการดำเนินงานวิจัยด้านการประเมินเทคโนโลยีด้านสุขภาพ",
  },
  {
    label: "p7",
    head: false,
    title: "7. ทักษะการประเมินความน่าเชื่อถือของงานวิจัยด้านเศรษฐศาสตร์สาธารณสุข",
  },
  {
    label: "p8",
    head: false,
    title:
      "8. ทักษะการประเมินความน่าเชื่อถือของงานวิจัยด้านการประเมินเทคโนโลยีด้านสุขภาพ",
  },
  {
    label: "p9",
    head: false,
    title:
      "9. อธิบายความเชื่อมโยงของการนำผลงานวิจัยด้านเศรษฐศาสตร์สาธารณสุขไปใช้ประโยชน์ในเชิงนโยบายด้านสุขภาพของประเทศ",
  },
  {
    label: "p10",
    head: false,
    title: "10. ระบุถึงความสำคัญของการประเมินเทคโนโลยีด้านสุขภาพ",
  },
  { label: "p11", head: false, title: "11. นำเสนอผลงานที่ได้รับมอบหมาย" },
  {
    label: "p12",
    head: false,
    title:
      "12. เขียนรายงานผลงาน หรือสรุปผลงานที่ได้รับมอบหมายในรูปแบบเอกสารต่างๆ ด้วยภาษาเขียนที่สื่อสารให้ผู้อ่านได้เข้าใจ",
  },
];
    ...
    <div className="grid grid-cols-1 gap-x-4 gap-y-4 sm:grid-cols-12 ">
      <div className="sm:col-span-12">
        ...
        <p className="text-sm text-gray-600">
          ...
          หรืออธิบายลักษณะอักษร และให้ประเมิน 2 ครั้ง คือในสัปดาห์ที่ 3 และ 6
          ของการฝึกปฏิบัติงาน ผลการประเมินในสัปดาห์ที่ 3
          ควรมีการแจ้งให้นักศึกษาราบ เพื่อให้เกิดการพัฒนา
          โดยคะแนนที่ใช้การประเมินผลการฝึกปฏิบัติงานจะคิดจากคะแนนในสัปดาห์ที่ 6
          <b>คำชี้แจง</b>
          <br />
          ให้ท่านทำเครื่องหมายกากบาท (x)
          ในช่องระดับคะแนนของแบบประเมินที่ตรงกับทักษะและความสามารถของนักศึกษาที่ท่านมุ่งสังเกตที่สุด
          (ประเมินทั้งในและนอกเอกสารฝึกปฏิบัติงาน)
          <br />
        </p>
      </div>
      <div className="sm:col-span-12 ">
