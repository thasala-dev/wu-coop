...
const criteriaData = [
  {
    ...
    head: false,
    title:
      "1. บทความที่ริเริ่มทำ : ความทันสมัย ความน่าสนใจ หรือประโยชน์ของการนำไปประยุกต์ใช้",
  },
  {
    label: "p2",
    head: false,
    title:
      "2. แถลงที่มานำไปสู่จิตวิทยาการ : ความเหมาะสมของเอกสารวิชาการที่เลือกใช้",
  },
  ...
  { label: "p3_2", head: true, title: "3.2 ระเบียบวิธีวิจัย" },
  {
    label: "p3_2_1",
    head: false,
    title: "รูปแบบการวิจัยและการออกแบบการศึกษากับคำถามวิจัย",
  },
  {
    label: "p3_2_2",
    head: false,
    title:
      "ประชากรและกลุ่มตัวอย่าง : มีความสอดคล้องกับคำถามวิจัย มีการระบุเกณฑ์การคัดเข้า/คัดออก อย่างเหมาะสม",
  },
  {
    label: "p3_2_3",
    head: false,
    title:
      "ขนาดกลุ่มตัวอย่าง : มีการระบุที่มาที่ชัดเจนของจำนวนกลุ่มตัวอย่าง เหมาะสม มีการรายงานผู้ป่วยที่ออกจากการศึกษา (drop out) มีการระบุการวิเคราะห์ในรูปแบบ intention-to-treat",
  },
  {
    label: "p3_2_4",
    head: false,
  ...
  },
  {
    label: "p3_2_5",
    head: false,
    title: "จริยธรรม : มีการพิจารณาความเหมาะสมของจริยธรรมและการเก็บข้อมูล",
  },
  {
    label: "p3_2_6",
    head: false,
    title: "เครื่องมือที่ใช้ : มีความถูกต้องตามรูปแบบงานวิจัย",
  },
  {
    label: "p3_2_7",
    head: false,
    title:
      "ตัวแปรและการวัดผลหลัก/การวิเคราะห์ผล : มีความสอดคล้องกับคำถามและวัตถุประสงค์",
  },
  {
    label: "p3_2_8",
    head: false,
    title:
      "การวัดผลซ้ำ : ถูกต้อง ครบถ้วน มีขอบเขต ตีความหมายต่อความต่างของผลลัพธ์ (treatment effect และ 95% confidence interval) รูปแบบการวิเคราะห์เหมาะสม",
  },
  {
    label: "p3_3",
    head: false,
    title:
      "3.3 สรุปผลและการตีความ : สอดคล้องกับคำถามวิจัยและวัตถุประสงค์ มีการประเมินจุดแข็งและข้อจำกัด",
  },
  {
    label: "p3_4",
    head: false,
    title:
      "3.4 การประยุกต์ใช้ผลการวิจัย : การประเมินการประยุกต์ใช้ผลวิจัยกับสถานการณ์บริบทของประเทศไทย",
  },
  ...
  { label: "p4_1", head: false, title: "4.1 นำเสนอผลงานได้ดึงดูดน่าสนใจ" },
  {
    ...
    head: false,
    title:
      "4.2 อธิบายและตอบคำถามที่ชัดเจนกับการนำเสนอ ง่ายต่อการติดตาม ภายในเวลาที่กำหนด",
  },
  {
    label: "p4_3",
    head: false,
    title:
      "4.3 การใช้ภาษาที่เหมาะสมกับการนำเสนอ สอดคล้องกับกลุ่มเป้าหมาย ต้องเวลา",
  },
  {
    label: "p4_4",
    head: false,
    title: "4.4 การจัดทำสื่อ : มีความสวยงาม เหมาะสม และสื่อสารง่าย",
  },
  { label: "p5", head: true, title: "5. การตอบคำถาม" },
  {
    ...
    head: false,
    title:
      "5.1 การตอบข้อซักถาม : ตอบชัดเจนและถูกต้อง มีเหตุผล และมีความรู้รอบด้าน",
  },
  {
    label: "p5_2",
    head: false,
    title:
      "5.2 การวิจารณ์ผลงาน : มีการประเมินข้อดีข้อเสียของงานวิจัยที่นำเสนอ รวมทั้งข้อเสนอแนะที่เป็นประโยชน์ต่อการประยุกต์ใช้ และปรับปรุงงานในอนาคต",
  },
];
