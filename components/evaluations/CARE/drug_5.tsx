          ...
          <tbody>
            <tr>
              ...
              <td className="p-2 border font-medium align-top text-sm">
                นิสิต/นักศึกษาแสดงให้เห็นว่ามีทักษะ/ความสามารถครบถ้วนในการปฏิบัติงานสร้างเสริมสุขภาพเป็นที่น่าพอใจ
 เกิดความบกพร่องน้อย สามารถปฏิบัติงานได้ด้วยตนเอง ตามแบบที่เภสัชกรพึงมี
              </td>
            </tr>
            <tr>
              <td className="p-2 border font-medium align-top text-sm text-center">
              ...
              <td className="p-2 border font-medium align-top text-sm">
นิสิต/นักศึกษาแสดงให้เห็นว่ามีทักษะ/ความสามารถในการปฏิบัติงานสร้างเสริมสุขภาพ มีความบกพร่อง
ในระดับยอมรับได้ สามารถปฏิบัติงานได้ด้วยตนเอง แต่ต้องได้รับคำแนะนำเป็นครั้งคราว              </td>
            </tr>
            <tr>
              <td className="p-2 border font-medium align-top text-sm text-center">
                3
              ...
              <td className="p-2 border font-medium align-top text-sm">
                นิสิต/นักศึกษาแสดงให้เห็นว่ามีทักษะ/ความสามารถในการปฏิบัติงานสร้างเสริมสุขภาพ มีความบกพร่องใน
ระดับยอมรับได้ ยังคงสามารถปฏิบัติงานได้ แต่ต้องได้รับคำแนะนำเป็นส่วนใหญ่
              </td>
            </tr>
            <tr>
              <td className="p-2 border font-medium align-top text-sm text-center">
              ...
              <td className="p-2 border font-medium align-top text-sm">
นิสิต/นักศึกษาแสดงให้เห็นว่าขาดทักษะ/ความสามารถในระดับไม่น่าเชื่อถือ เกิดความบกพร่องอยู่เสมอ 
การปฏิบัติงานอยู่ภายใต้การดูแลจากอาจารย์ประจำแหล่งฝึกอย่างใกล้ชิด              </td>
            </tr>
            <tr>
              <td className="p-2 border font-medium align-top text-sm text-center">
                1
              ...
              <td className="p-2 border font-medium align-top text-sm">
นิสิต/นักศึกษาแสดงให้เห็นว่าขาดทักษะ/ความสามารถ ไม่สามารถปฏิบัติงานสร้างเสริมสุขภาพได้ 
เกิดความผิดพลาดซ้ำ และไม่ปรับปรุงตามตำแนะนำของอาจารย์ประจำแหล่งฝึก              </td>
            </tr>
          </tbody>
        </table>
      </div>
                ...
                <>
                  ...
                  <div className="border-t border-blue-300 pt-2 mt-2">
                    <div className="flex justify-between items-center text-sm">
                      <span className="font-medium">คะแนน (คะแนนที่ได้ x 10) ÷ ฐานคะแนนที่มีการประเมินจริง:</span>
