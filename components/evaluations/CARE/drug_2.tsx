          ...
          <tbody>
            <tr>
              ...
              <td className="p-2 border font-medium align-top text-sm">
                นิสิต/นักศึกษาแสดงให้เห็นว่ามีทักษะ/ความสามารถครบถ้วนตาม
วัตถุประสงค์การฝึกปฏิบัติงานฯ มีความบกพร่องในระดับยอมรับได้ สามารถปฏิบัติ
งานได้ด้วยตนเองตามแบบที่เภสัชกรพึงมี
              </td>
            </tr>
            <tr>
              <td className="p-2 border font-medium align-top text-sm text-center">
              ...
              <td className="p-2 border font-medium align-top text-sm">
           นิสิต/นักศึกษาแสดงให้เห็นว่ามีทักษะ/ความสามารถตาม
วัตถุประสงค์การฝึกปฏิบัติงานฯ มีความบกพร่องในระดับยอมรับได้ สามารถปฏิบัติ
งานได้ด้วยตนเอง แต่ต้องได้รับคำแนะนำเป็นครั้งคราว
              </td>
            </tr>
            <tr>
              <td className="p-2 border font-medium align-top text-sm text-center">
              ...
              <td className="p-2 border font-medium align-top text-sm">
นิสิต/นักศึกษาแสดงให้เห็นว่ามีทักษะ/ความสามารถตาม
วัตถุประสงค์การฝึกปฏิบัติงานฯ มีความบกพร่องในระดับยอมรับได้ ยังคงสามารถปฏิบัติ
งานได้ แต่ต้องได้รับคำแนะนำเป็นส่วนใหญ่              </td>
            </tr>
            <tr>
              <td className="p-2 border font-medium align-top text-sm text-center">
                2
              ...
              <td className="p-2 border font-medium align-top text-sm">
นิสิต/นักศึกษาแสดงให้เห็นว่าขาดทักษะ/ความสามารถในระดับไม่น่า
เชื่อถือ เกิดความบกพร่องอยู่เสมอ การปฏิบัติงานอยู่ภายใต้การดูแลจากอาจารย์แหล่งฝึก
อย่างใกล้ชิด              </td>
            </tr>
            <tr>
              <td className="p-2 border font-medium align-top text-sm text-center">
              ...
              <td className="p-2 border font-medium align-top text-sm">
                นิสิต/นักศึกษาแสดงให้เห็นว่าขาดทักษะ/ความสามารถ ไม่ผ่านตามวัตถุประสงค์
การปฏิบัติงานฯ ไม่สามารถปฏิบัติงานได้ เกิดความผิดพลาดซ้ำ และไม่ปรับปรุงตามคำแนะนำ
ของอาจารย์แหล่งฝึก
              </td>
            </tr>
          </tbody>
