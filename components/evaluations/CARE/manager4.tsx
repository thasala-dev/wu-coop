...
{ label: "p3_3", head: false, title: `๓.๓ กำหนดวัตถุประสงค์ของโครงการ / แผนชัดเจน และมี Strategic plan และ Action Plan` },
...
{ label: "p4", head: true, title: `๔. การสรุปทั้งหมด` },
{ label: "p4_1", head: false, title: `๔.๑ สามารถขยายการอธิบาย และความเข้าใจในภาพรวมของโครงการ / แผนได้` },
          ...
          <tbody>
            <tr>
              ...
              <td className="p-2 border font-medium align-top text-sm">
                นิสิต/นักศึกษาสามารถนำเสนอในรายงาน ได้ถูกต้อง ครบถ้วนแสดงความรู้/ความคิดเห็นอย่างเหมาะสมดีเยี่ยม
              </td>
            </tr>
            <tr>
              <td className="p-2 border font-medium align-top text-sm text-center">
...
แสดงความรู้/ความคิดเห็นอย่างเหมาะสม
แต่การปรับปรุงน้อยเล็กๆ น้อยๆ
