...
const criteriaData = {
  p1_1: {
    title: "1. ความเสียสละและเอาใจใส่ต่อการฝึกปฏิบัติงานวิชาชีพ",
    description:
      "นิสิต/นักศึกษามีความเสียสละและมุ่งมั่นในการฝึกปฏิบัติงานวิชาชีพ มีความเอาใจใส่ในการรับฟังคำแนะนำผู้สอนเป็นสำคัญ ปฏิบัติตัวอยู่ในสถานที่ที่กำหนดให้และเขียนรายงานตรงเวลามากกว่าร้อยละ 80 ของช่วงเวลาของการฝึกปฏิบัติงานวิชาชีพทั้งหมด",
  },
  p1_2: {
