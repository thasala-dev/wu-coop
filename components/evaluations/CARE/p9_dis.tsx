          ...
          <table className="w-full text-xs sm:text-sm">
            ...
            <tbody>
              ...
              <tr className="border-b">
                ...
                <td className="p-2">
                  นิสิต/นักศึกษาแสดงให้เห็นว่ามีทักษะ/ความสามารถตามวัตถุประสงค์การฝึกปฏิบัติงาน มีความมั่นพอใจระดับยอมรับได้ สามารถปฏิบัติงานได้ด้วยตนเอง แต่ได้รับคำแนะนำเป็นจริงครั้งคราว
                </td>
              </tr>
              <tr className="border-b">
