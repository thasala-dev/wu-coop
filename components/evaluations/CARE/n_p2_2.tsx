...
const interviewCriteria = [
  {
    key: "greeting",
    title: "การกล่าวทักทายและแนะนำตนเอง",
    description:
      "เริ่มต้นการสัมภาษณ์อย่างสุภาพ ชี้แจงตัวตนและวัตถุประสงค์ของการสนทนา",
  },
  {
    key: "identity",
    title: "การยืนยันตัวผู้ป่วย",
    description: "ถามชื่อและนามสกุลของผู้ป่วย รวมถึงอายุของผู้ป่วย",
  },
  {
    key: "illness",
    title: "กรณีสัมภาษณ์ความเจ็บป่วย",
    description:
      "ถามอาการผิดปกติที่มาพบแพทย์/เภสัชกร โดยใช้คำถามปลายเปิด ถามอาการหลัก อาการอื่น อาการรุนแรงที่ต้องพบแพทย์ และใช้คำถามปิดเมื่อต้องการแยกโรค ถามการใช้ยาและสมุนไพรก่อนมาพบเภสัชกร อาชีพหรือสิ่งแวดล้อมที่เกี่ยวข้อง การสูบบุหรี่ ดื่มแอลกอฮอล์หรือใช้ยาเสพติด อาการป่วยของคนในครอบครัว โรคประจำตัว ยาที่ใช้ประจำ ประวัติแพ้ยา โอกาสตั้งครรภ์หรือให้นมบุตร จากนั้นสรุปอาการและขอบคุณผู้ป่วย",
  },
  {
    key: "allergy",
    title: "กรณีสัมภาษณ์ประวัติการแพ้ยา",
    description:
      "ถามชื่อยาและรายละเอียดการใช้ อาการและระยะเวลาที่เกิด อาการอื่น เช่น อาการทางระบบทางเดินหายใจ ระยะเวลาหลังได้รับยา สาเหตุที่ได้รับยา ยาอื่นที่ได้รับพร้อมกัน การรักษาอาการแพ้ยา ประวัติการได้รับยาที่มี cross-reactivity ยาชนิดเดียวกันหรือยากลุ่มเดียวกัน และประวัติอาการดังกล่าวเมื่อไม่ได้รับยา จากนั้นขอบคุณผู้ป่วย",
  },
  {
    key: "medication",
    title: "กรณีสัมภาษณ์ประวัติการใช้ยา",
    description:
      "ถามชื่อยาทั้งชื่อสามัญและชื่อการค้า วิธีใช้ยา การเก็บรักษา การลืมใช้ยา ผลิตภัณฑ์เสริมอาหารหรือสมุนไพรอื่น ๆ ที่ใช้ร่วม และขอบคุณผู้ป่วย",
  },
  {
    key: "counseling",
    title: "การให้คำแนะนำปรึกษาทางยาแก่ผู้ป่วย",
    description:
      "ถามเหตุผลที่มาพบแพทย์ ผลการรักษาโรคเรื้อรัง เช่น ความดันโลหิต ใช้ prime questions ๓ ข้อและเทคนิค show and tell ให้ข้อมูลยาครบถ้วน โดยเฉพาะยาใหม่หรือยาที่เปลี่ยนวิธีใช้ ให้ผู้ป่วยทวน ตรวจสอบว่ามีคำถามเพิ่มเติมหรือไม่ และขอบคุณผู้ป่วย",
  },
];
...
const criteriaData = [
  {
    ...
    excellent: [
      ...
      "บริหารจัดการเวลาในการสื่อสารได้อย่างเหมาะสม",
    ],
    good: [
      "สื่อสารกับผู้ป่วยได้อย่างเหมาะสมและสอดคล้องตามเกณฑ์การสัมภาษณ์ผู้ป่วย",
  ...
  },
  {
    ...
    excellent: [
      ...
      "ใช้กิริยาท่าทางและวาจาที่ให้เกียรติแก่ผู้ป่วยตลอดเวลา",
      "ระมัดระวังการพูดในสิ่งที่เป็นความลับของผู้ป่วย",
    ],
    good: [
      "มีบุคลิกดูน่าเชื่อถือและแสดงออกให้เห็นถึงความเป็นเภสัชกรมืออาชีพอย่างชัดเจน",
      "ใช้กิริยาท่าทางและวาจาที่ให้เกียรติแก่ผู้ป่วยตลอดเวลา",
    ...
    pass: [
      ...
      "ใช้กิริยาท่าทางและวาจาที่ให้เกียรติแก่ผู้ป่วย",
    ],
    improve: [
      "มีบุคลิกดูไม่น่าเชื่อถือ",
      "ใช้กิริยาท่าทางหรือวาจาที่ไม่ให้เกียรติแก่ผู้ป่วย",
    ],
  },
  {
    key: "decisionScore",
    ...
    excellent: [
      ...
      "ตัดสินใจโดยคำนึงถึงความต้องการของผู้ป่วยเป็นสำคัญ",
    ],
    good: [
      "ตัดสินใจอย่างมีเหตุผล โดยนำข้อมูลที่เกี่ยวข้องพร้อมทั้งยกหลักฐานทางวิชาการมาใช้ประกอบการตัดสินใจ",
    ],
    ...
    <div className="grid grid-cols-1 gap-5 sm:grid-cols-12">
      <header className="space-y-1 text-center sm:col-span-12">
        <h2 className="text-base font-bold sm:text-lg">
          แบบประเมินทักษะการสื่อสารในงานบริบาลทางเภสัชกรรมกับผู้ป่วย/ผู้ให้การดูแล
        </h2>
      ...
      <section className="space-y-3 text-sm leading-7 sm:col-span-12">
        ...
        <p>
          ...
          assessment ชนิดหนึ่ง โดยมุ่งประเมินทักษะทางคลินิก (clinical skill)
          ของนิสิต/นักศึกษาในสถานการณ์จริง (ผู้ป่วยจริง)
          โดยมีอาจารย์แหล่งฝึกเป็นผู้ประเมิน ทักษะทางคลินิกดังกล่าวจะประเมินใน ๒
          ประเด็น คือ ทักษะการสัมภาษณ์ผู้ป่วย (psychomotor domain)
          และความเป็นวิชาชีพ (professional domain)
          โดยมุ่งเน้นทักษะในการเผชิญหน้า (encounter) กับผู้ป่วย
          กระบวนการตัดสินใจ และการปฏิบัติตามเกณฑ์การสัมภาษณ์ผู้ป่วย
          เพื่อให้ได้ข้อมูลที่เภสัชกรต้องการจากผู้ป่วย เช่น ประวัติการใช้ยา
          ได้อย่างถูกต้อง โดยอาจประเมินหลายครั้งและประเมินเป็น formative
        </p>
        ...
        <ol className="list-decimal space-y-1 pl-6">
          <li>
            อาจารย์แหล่งฝึกเตรียมหาข้อมูลผู้ป่วยไว้ล่วงหน้า
            โดยขออนุญาตผู้ป่วยว่าจะมีนิสิต/นักศึกษามาฝึกปฏิบัติ
          </li>
          <li>
            อาจารย์แหล่งฝึกแนะนำขั้นตอนและเกณฑ์การประเมิน
            และให้นิสิต/นักศึกษาเลือกประเด็นที่จะสัมภาษณ์ เช่น
            การสัมภาษณ์การแพ้ยา
          </li>
          <li>
            อาจารย์แหล่งฝึกเฝ้าดูและให้การช่วยเหลือเฉพาะเมื่อจำเป็น เช่น
            ผู้ป่วยเริ่มเหนื่อยจากการให้สัมภาษณ์
            ไม่ควรช่วยนิสิต/นักศึกษาสัมภาษณ์ ซึ่งใช้เวลาไม่เกิน ๑๕ นาที
          </li>
          <li>
            หลังเสร็จสิ้น อาจารย์แหล่งฝึกสะท้อน (reflection) หรือแจ้ง (feedback)
            ผลการประเมิน ใช้เวลาไม่เกิน ๕ นาที
          </li>
        </ol>
