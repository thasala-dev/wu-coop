          ...
          <tbody>
            <tr>
              ...
              <td className="p-2 border font-medium align-top text-sm">
                นิสิต/นักศึกษาสามารถนำเสนอ อภิปรายและตอบคำถามได้ถูกต้องครบถ้วน แสดง
ความรู้/ความคิดเห็นบนพื้นฐานองค์ความรู้ใหม่อย่างเหมาะสม สามารถอภิปรายประเด็นการดูแลผู้ป่วย
ด้านยาที่สำคัญ (Critical point) และนำไปประยุกต์ใช้ในการดูแลผู้ป่วยเฉพาะรายได้จริง ตามแบบที่
เภสัชกรพึงมี
              </td>
            </tr>
            <tr>
              ...
              <td className="p-2 border font-medium align-top text-sm">
                นิสิต/นักศึกษาสามารถนำเสนอ อภิปรายและตอบคำถามได้ถูกต้อง แสดงความรู้/
ความคิดเห็นบนพื้นฐานแนวทางการรักษาที่เป็นปัจจุบัน สามารถอภิปรายประเด็นการดูแลผู้ป่วย
ด้านยาที่สำคัญและนำไปประยุกต์ใช้ในการดูแลผู้ป่วยเฉพาะรายได้บางส่วน แต่ต้องได้รับคำแนะนำบ้าง
              </td>
            </tr>
            <tr>
              <td className="p-2 border font-medium align-top text-sm text-center">
              ...
              <td className="p-2 border font-medium align-top text-sm">
                นิสิต/นักศึกษาสามารถนำเสนอ อภิปรายและตอบคำถามได้ถูกต้องบางส่วน มีองค์ความรู้
พื้นฐาน ยังขาดความเข้าใจภาพรวมของกรณีศึกษา ยังไม่สามารถนำไปประยุกต์ใช้ในการดูแลผู้ป่วยได้
ด้วยตนเอง ต้องได้รับคำแนะนำ
              </td>
            </tr>
            <tr>
              <td className="p-2 border font-medium align-top text-sm text-center">
              ...
              <td className="p-2 border font-medium align-top text-sm">
                นิสิต/นักศึกษาสามารถนำเสนอ อภิปรายและตอบคำถามได้ถูกต้องบางส่วน ขาดข้อมูลสำคัญ
และความเข้าใจภาพรวมของกรณีศึกษา ไม่สามารถนำไปประยุกต์ใช้ในการดูแลผู้ป่วยได้ ต้องได้รับคำแนะนำ
เป็นส่วนใหญ่
              </td>
            </tr>
            <tr>
              ...
              <td className="p-2 border font-medium align-top text-sm">
                นิสิต/นักศึกษานำเสนอไม่ถูกต้อง ไม่สามารถอภิปรายและตอบคำถามได้ ขาดข้อมูลสำคัญและ
ความเข้าใจภาพรวมของกรณีศึกษา ต้องสอนการทำกรณีศึกษาใหม่
              </td>
            </tr>
          </tbody>
        </table>
