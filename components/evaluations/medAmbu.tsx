...
export default function MedAmbu({
  ...
  const criteriaData = {
    p1_1: {
      ...
      description:
        "นิสิต/นักศึกษามีความตั้งใจและทุ่มเท ในการฝึกปฏิบัติงานวิชาชีพ มีความเอาใจใส่ในการบริบาลเภสัชกรรมแก่ผู้ป่วยเป็นสำคัญ ปฏิบัติตัวต่อผู้อื่นอย่างเห็นอกเห็นใจและเห็นต่อประโยชน์ของผู้อื่นมากกว่าประโยชน์ของตนเอง",
    },
    p1_2: {
