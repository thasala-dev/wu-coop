...
export default function MedAmbu({
  ...
  const criteriaData = {
    p1_1: {
      title: "๑. ความสนใจและเอาใจใส่ต่อการฝึกปฏิบัติงานวิชาชีพ",
      description:
    ...
    p1_2: {
      title: "๒. ความซื่อสัตย์และจรรยาบรรณวิชาชีพ",
      description:
    ...
    p1_4: {
      title: "๔. ความเป็นวิชาชีพ มนุษยธรรม",
      description:
    ...
    p1_5: {
      title: "๕. ความใฝ่รู้และความพยายามในการฝีกปฏิบัติงานวิชาชีพ",
      description:
    ...
    p1_6: {
      title: "๖. ความรับผิดชอบในการฝึกปฏิบัติงานวิชาชีพ",
      description:
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <CardDescription className="text-sm">
                สำหรับอาจารย์ประจำแหล่งฝึก (แบบ-ป-๑)
              </CardDescription>
            </div>
            <div className="border border-gray-800 p-2">
              <h3 className="font-semibold text-sm">แบบ-ป-๑</h3>
            </div>
          </div>
        </CardHeader>
              ...
              <div className="grid grid-cols-1 gap-4">
                <div className="">
                  <p className="text-sm">
                    ...
                    ทั้งโดยวาจา หรือลายลักษณ์อักษร และให้ประเมิน ๒ ครั้ง
                    คือในสัปดาห์ที่ ๓ และ ๖ ของการฝึกปฏิบัติงาน
                    ผลการประเมินในสัปดาห์ที่ ๓
                ...
                <div className="rounded-md bg-blue-50 p-4 border border-blue-200">
                  ...
                  <p className="text-xs sm:text-sm mb-2">
                    ...
                    <u className="font-bold">
                      นิสิต/นักศึกษาจะต้องผ่านทั้ง ๖
