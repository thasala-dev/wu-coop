...
type FormState = {
  ...
  clinic?: {
    ...
    homeCare?: ClinicActivity & {
      isService?:
        | "เป็นกิจกรรมเฉพาะของร้านยา"
        | "เป็นกิจกรรมร่วมกับสถานพยาบาล"
        | "";
      serviceOther?: string;
      qualityProgram?: "เข้าร่วม" | "ไม่ได้เข้าร่วม" | "";
    };
  ...
  return (
    <Card className="bg-white border-0 shadow-lg hover:shadow-xl transition-all">
      <div className="p-4 space-y-8">
        ...
        <section className="space-y-3">
          ...
          <div className="space-y-2">
            ...
            {(form.multiTimeNotes || [{}, {}, {}]).map((row, i) => (
              <div key={i} className="grid md:grid-cols-3 gap-2">
                ...
                />
                <Input
                  placeholder="มีนักศึกษาฝึกงาน ... คน"
                  value={row.count || ""}
                  onChange={(e) => {
                    const arr = [...(form.multiTimeNotes || [])];
          ...
          <div className="grid md:grid-cols-3 gap-2">
            <div>
              ...
              <Input
                value={form.servePerDay || ""}
                onChange={(e) => set("servePerDay", e.target.value)}
              />
            </div>
          </div>
        </section>
        ...
        <section className="space-y-3">
          ...
          <div className="grid md:grid-cols-3 gap-2">
            {(form.advisors || []).map((v, i) => (
              <Input
                key={i}
                placeholder={`${i + 1}. ชื่ออาจารย์นิเทศ`}
                value={v}
                onChange={(e) => {
        ...
        <section className="space-y-3">
          <div className="font-medium">
            4) ความปลอดภัยของสถานที่ในการฝึกปฏิบัติงาน
          </div>
          <div className="space-y-2">
          ...
          <div className="grid md:grid-cols-2 gap-3">
            <div>
              ...
              <Input
                ...
                value={form.safetyStayTravelNote || ""}
        ...
        <section className="space-y-3">
          <div className="font-medium">
            5) การฝึกปฏิบัติงานที่นิสิต/นักศึกษาได้ปฏิบัติ
          </div>
          <Label>
            {" "}
            5.1 กิจกรรมการฝึกงานที่นิสิตนักศึกษาได้ปฏิบัติ (เลือกได้มากกว่า 1
            ข้อ)
          </Label>
          <div className="grid md:grid-cols-1 gap-2">
            {[
              ...
              [
                "diseaseDiagnosis",
                "การวิเคราะห์แยกโรค และวินิจฉัยทางเภสัชกรรม",
              ],
              [
                "chronicHistory",
                "การสอบถามประวัติและติดตามในผู้ป่วยโรคเรื้อรัง",
              ],
              [
                "riskScreening",
                "การคัดกรองผู้ป่วยที่มีความเสี่ยงในการเป็นโรคเรื้อรังหรืออื่นๆ เช่น โปรดระบุ",
              ],
              ["medicationSelection", "การเลือกยาเพื่อรักษาโรค/อาการ"],
              ["medicationDispensing", "การส่งมอบยาให้กับผู้มารับบริการ"],
              [
                "medicationProfile",
                "การจัดทำประวัติการใช้ยาของผู้มารับบริการ (Medication Profile)",
              ],
              [
                "drugProblemResolution",
                "การสืบค้นปัญหาจากการใช้ยา และเสนอแนะแนวทางการแก้ไขปัญหาที่เกิดขึ้น",
              ],
              [
                "medicationMonitoring",
                "การติดตามและประเมินผลการใช้ยาของผู้ป่วย/อาการไม่พึงประสงค์จากการใช้ยา",
              ],
              [
                "patientCounseling",
                "การให้คำแนะนำ/ปรึกษาผู้มารับบริการเรื่องโรค การใช้ยา การป้องกันการกลับเป็นซ้ำ การปรับเปลี่ยนพฤติกรรมสุขภาพ",
              ],
              ["specialTechnique", "การแนะนำวิธีใช้ยาเทคนิคพิเศษ"],
              [
                "healthProductInfo",
                "การให้บริการสารสนเทศเกี่ยวกับผลิตภัณฑ์สุขภาพ",
              ],
              [
                "patientReferral",
                "การส่งต่อผู้ป่วยและผู้รับบริการเพื่อรับการรักษาที่เหมาะสมในสถานพยาบาล",
              ],
              ["pharmacyManagement", "การบริหารร้านยา เช่น การบริหารเวชภัณฑ์"],
              [
                "communityActivities",
                "กิจกรรมอื่นๆ เช่น การเยี่ยมบ้านผู้ป่วย บริการเลิกบุหรี่ การให้ความรู้หรือการแก้ไขปัญหาสุขภาพในชุมชน การให้บริการผลิตภัณฑ์สุขภาพอื่นๆ โปรดระบุ",
              ],
            ].map(([k, l]) => (
          ...
          <Input
            placeholder="อื่น ๆ (ระบุ)"
            value={form.activitiesDone?.other || ""}
            onChange={(e) =>
              set("activitiesDone", {
                ...(form.activitiesDone || {}),
        ...
        <section className="space-y-3">
          <div className="font-medium">
            6) ปัญหาที่เกี่ยวข้องกับการฝึกปฏิบัติงาน
            *สามารถระบุคำแนะนำเพิ่มเติมลงในท้ายของแต่ละปัญหา
          </div>

          {/* 6.1.1 */}
          <div className="rounded-md border">
            <div className="p-2 font-medium bg-slate-50">
              6.1.1 บุคลิกภาพและความประพฤติระหว่างการฝึกปฏิบัติงาน
            </div>
            {[
              ...
              <div key={k} className="grid md:grid-cols-6 gap-2 p-3 border-t">
                ...
                <label className="flex items-center gap-2">
                  <Checkbox
                    checked={(form.p611 as any)?.[k]?.none}
                ...
                <label className="flex items-center gap-2">
                  <Checkbox
                    checked={(form.p611 as any)?.[k]?.has}
                ...
                <div className="md:col-span-2">
                  <Input
                    ...
                    value={(form.p611 as any)?.[k]?.note || ""}
                    onChange={(e) =>
                      setNested(`p611.${k}.note`, e.target.value)
                    }
                  />
                </div>
              </div>
          ...
          <div className="rounded-md border">
            <div className="p-2 font-medium bg-slate-50">
              6.2.2 ความสามารถของนิสิต/นักศึกษา
            </div>
            {[
              ...
              <div key={k} className="grid md:grid-cols-6 gap-2 p-3 border-t">
                ...
                <label className="flex items-center gap-2">
                  <Checkbox
                    checked={(form.p622 as any)?.[k]?.none}
                ...
                <label className="flex items-center gap-2">
                  <Checkbox
                    checked={(form.p622 as any)?.[k]?.has}
                ...
                <div className="md:col-span-2">
                  <Input
                    placeholder="รายละเอียด"
                    value={(form.p622 as any)?.[k]?.note || ""}
                    onChange={(e) =>
                      setNested(`p622.${k}.note`, e.target.value)
                    }
                  />
                </div>
              </div>
        ...
        <section className="space-y-3">
          <div className="font-medium">
            7) งานทางเภสัชกรรมคลินิกที่มีในร้านยา
          </div>

          {/* 1. counseling */}
          <div className="rounded-md border p-3 space-y-2">
            <div className="font-medium">
              1) การให้บริการผู้ป่วยโรคเรื้อรัง (counseling)
            </div>
            ...
            <div className="grid md:grid-cols-1 gap-2">
              {[
                [
                  "reviewMedication",
                  "ทบทวนการใช้ยาของผู้ป่วยและประเมินปัญหาการใช้ยา & อื่น ๆ",
                ],
                ["hasProfile", "มีการบันทึกข้อมูลผู้ป่วย (patient profile)"],
                [
                  "hasReferral",
                  "มีการประเมิน/ส่งต่อผู้ป่วยไปสถานพยาบาล (เช่น ทำบันทึกข้อความถึงแพทย์)",
                ],
                ["hasFollowup", "มีการติดตามผู้ป่วยต่อเนื่อง"],
              ].map(([k, l]) => (
                <label key={k} className="flex items-start gap-2">
                  <Checkbox
                    checked={(form.clinic?.counseling as any)?.[k]}
                    onCheckedChange={(c) =>
                      setNested(`clinic.counseling.${k}`, !!c)
                    }
                  />
                  <span className="text-sm">{l}</span>
                </label>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                value={form.clinic?.counseling?.otherText || ""}
                onChange={(e) =>
                  setNested("clinic.counseling.otherText", e.target.value)
                }
              />
            </div>
            <div className="grid md:grid-cols-2 gap-2">
              <div className="space-y-1">
                <Label className="text-sm">
                  จำนวนผู้รับบริการโดยเฉลี่ยต่อสัปดาห์ (คน)
                </Label>
                <Input
                  placeholder="จำนวน..."
                  value={form.clinic?.counseling?.byStuPerDay || ""}
                  onChange={(e) =>
                    setNested("clinic.counseling.byStuPerDay", e.target.value)
                  }
                />
              </div>
              <div className="space-y-1">
                ...
                <Input
                  ...
                  value={form.clinic?.counseling?.infoFrom || ""}
                  onChange={(e) =>
                    setNested("clinic.counseling.infoFrom", e.target.value)
                  }
                />
              </div>
            </div>
          ...
          <div className="rounded-md border p-3 space-y-2">
            <div className="font-medium">
              2) การให้บริการเลิกบุหรี่ (smoking cessation)
              ในที่นี้รวมได้แม้ว่าจะไม่ได้ทำครบ 5A
            </div>
            <div className="space-y-3">
              <div>
                ...
                <RadioGroup
                  ...
                  onValueChange={(val) =>
                    setNested("clinic.stopSmoking.level", val as any)
                  }
                >
              ...
              <div className="grid md:grid-cols-2 gap-2">
                <div className="space-y-1">
                  ...
                  <Input
                    placeholder="ระบุปี..."
                    value={form.clinic?.stopSmoking?.plannedYear || ""}
                    onChange={(e) =>
                      setNested(
                ...
                <div className="space-y-1">
                  <Label className="text-sm">
                    มีผลิตภัณฑ์ช่วยเลิกบุหรี่จำหน่าย ได้แก่
                  </Label>
                  <Input
                    placeholder="ระบุผลิตภัณฑ์..."
                    value={form.clinic?.stopSmoking?.products || ""}
                    onChange={(e) =>
                      setNested("clinic.stopSmoking.products", e.target.value)
                    }
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    setNested("clinic.stopSmoking.details", e.target.value)
                  }
                />
              </div>
            </div>
          ...
          <div className="rounded-md border p-3 space-y-2">
            <div className="font-medium">
              3) การให้บริการคัดกรองความเสี่ยงด้านสุขภาพ (health risk screening)
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap gap-4">
                {[
                  ...
                  <label key={k} className="flex items-center gap-2">
                    <Checkbox
                      checked={(form.clinic?.riskScreen?.targets as any)?.[k]}
                      onCheckedChange={(c) =>
                        setNested(`clinic.riskScreen.targets.${k}`, !!c)
                      }
                    />
                    <span className="text-sm">{l}</span>
                  </label>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Input
                    className="w-56"
                    value={form.clinic?.riskScreen?.targets?.other || ""}
                    onChange={(e) =>
                      setNested(
            ...
            <div className="space-y-2">
              ...
              <RadioGroup
                ...
                onValueChange={(val) =>
                  setNested("clinic.riskScreen.timing", val as any)
                }
              >
                <label className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <Input
                  className="w-56"
                  value={form.clinic?.riskScreen?.timingOther || ""}
                  onChange={(e) =>
                    setNested("clinic.riskScreen.timingOther", e.target.value)
                  }
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              <Label className="text-sm">
                เข้าร่วมโครงการร้านยาคุณภาพกับสปสช
              </Label>
              <RadioGroup
                className="flex gap-4"
                value={form.clinic?.riskScreen?.qualityProgram || ""}
                onValueChange={(val) =>
                  setNested("clinic.riskScreen.qualityProgram", val as any)
                }
              >
                <label className="flex items-center gap-2">
            ...
            <Textarea
              ...
              onChange={(e) =>
                setNested("clinic.riskScreen.details", e.target.value)
              }
            />
          </div>
          ...
          <div className="rounded-md border p-3 space-y-2">
            <div className="font-medium">
              4) การเยี่ยมติดตามดูแลผู้ป่วยที่บ้าน (home health care)
            </div>
            ...
            <div className="space-y-2">
              ...
              <RadioGroup
                ...
                onValueChange={(val) =>
                  setNested("clinic.homeCare.isService", val as any)
                }
              >
                <label className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <Input
                  className="w-56"
                  value={form.clinic?.homeCare?.serviceOther || ""}
                  onChange={(e) =>
                    setNested("clinic.homeCare.serviceOther", e.target.value)
                  }
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              <Label className="text-sm">
                เข้าร่วมโครงการร้านยาคุณภาพกับสปสชหรือไม่
              </Label>
              <RadioGroup
                className="flex gap-4"
                value={form.clinic?.homeCare?.qualityProgram || ""}
                onValueChange={(val) =>
                  setNested("clinic.homeCare.qualityProgram", val as any)
                }
              >
                <label className="flex items-center gap-2">
                  <RadioGroupItem value="เข้าร่วม" />
            ...
            <Textarea
              ...
              onChange={(e) =>
                setNested("clinic.homeCare.details", e.target.value)
              }
            />
          </div>
          ...
          <div className="rounded-md border p-3 space-y-2">
            <div className="font-medium">
              5) การมีกิจกรรมรณรงค์เรื่องสุขภาพหรือการใช้ยาในชุมชน
            </div>
            ในปีที่ผ่านมา จัดหรือเข้าร่วมจัดกิจกรรมใดบ้าง ลักษณะกิจกรรม
            <Textarea
              rows={3}
              placeholder="รายละเอียดกิจกรรม/วันที่/สถานที่ วันเวลาที่จัดงาน"
              value={form.clinic?.massScreen?.details || ""}
              onChange={(e) =>
                setNested("clinic.massScreen.details", e.target.value)
              }
            />
          </div>
        ...
        <section className="space-y-3">
          ...
          {[
            ...
            <div
              key={k}
              className="grid md:grid-cols-6 gap-2 p-3 border rounded-md"
            >
              <div className="md:col-span-2 font-medium text-sm">{title}</div>
              <label className="flex items-center gap-2">
                <Checkbox
                  checked={(form.hostComments as any)?.[k]?.none}
                  onCheckedChange={(c) =>
                    setNested(`hostComments.${k}.none`, !!c)
                  }
                />
                <span className="text-sm">ไม่พบปัญหา</span>
              </label>
              <label className="flex items-center gap-2">
                <Checkbox
                  checked={(form.hostComments as any)?.[k]?.has}
                  onCheckedChange={(c) =>
                    setNested(`hostComments.${k}.has`, !!c)
                  }
                />
                <span className="text-sm">มีข้อเสนอแนะ</span>
              </label>
              <div className="md:col-span-2">
                <Textarea
                  ...
                  onChange={(e) =>
                    setNested(`hostComments.${k}.note`, e.target.value)
                  }
                />
              </div>
            </div>
          ...
          {[
            ...
            <div key={k} className="grid md:grid-cols-4 gap-2">
              ...
              <div className="md:col-span-3">
                <Input
                  value={(form.support as any)?.[k] || ""}
                  onChange={(e) => setNested(`support.${k}`, e.target.value)}
                />
              </div>
            </div>
          ))}
        ...
        <section className="grid md:grid-cols-2 gap-3">
          <div className="rounded-md border p-3">
            ...
            <Input
              className="mt-2"
              placeholder="เหตุผล"
              value={form.consentSurveyReason || ""}
          ...
          <div className="rounded-md border p-3">
            <div className="font-medium space-y-1">
              <div>
                ...
                โปรแกรมการให้บริการคัดกรองความเสี่ยงด้านสุขภาพ หรือ
            ...
            <Input
              className="mt-2"
              placeholder="เหตุผล"
              value={form.consentClientDataReason || ""}
        ...
        <section className="space-y-3">
          <div className="font-medium">
            12) การประเมินแหล่งฝึก โดยอาจารย์นิเทศ
          </div>
          <div className="grid md:grid-cols-2 gap-2">
            <label className="flex items-center gap-2">
              <Checkbox
                checked={!!form.siteEvaluation?.suitable}
                onCheckedChange={(c) =>
                  set("siteEvaluation", {
                    ...(form.siteEvaluation || {}),
                    suitable: !!c,
              ...
              <span className="text-sm">
                เป็นแหล่งฝึกที่เหมาะสำหรับเป็นแหล่งฝึกทางบริบาลเภสัชกรรม
              </span>
            </label>
            <div className="flex items-start gap-2">
              <Checkbox
                checked={!!form.siteEvaluation?.suitableSpecific}
                onCheckedChange={(c) =>
                  set("siteEvaluation", {
                    ...(form.siteEvaluation || {}),
                    suitableSpecific: !!c,
              ...
              />
              <Input
                placeholder="เหมาะสมสำหรับ... (ระบุ)"
                value={form.siteEvaluation?.suitableSpecificText || ""}
                onChange={(e) =>
                  set("siteEvaluation", {
                    ...(form.siteEvaluation || {}),
                    suitableSpecificText: e.target.value,
                  })
                }
              />
            </div>
