      ...
      <div className="p-4 space-y-6">
        ...
        <div className="space-y-2 pt-4">
          ...
          <div className="flex flex-wrap items-center gap-4">
            <label className="flex items-center gap-2">
              <Checkbox
                checked={formData.supervision_mode?.includes(
                  "เดินทางไปแหล่งฝึก",
                )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-2">
            ...
            {["ไม่มี", "มี"].map((w) => (
              <label key={w} className="flex items-center gap-2">
                <input
                  ...
                  onChange={() =>
                    setFormData({ ...formData, housing_fee_has: w })
                  }
                />
                <span>{w}</span>
              </label>
              ...
              <>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      housing_fee_amt: e.target.value,
                    })
                  }
                />
            ...
            {["ไม่มี", "มี"].map((w) => (
              <label key={w} className="flex items-center gap-2">
                <input
                  ...
                  onChange={() =>
                    setFormData({ ...formData, allowance_has: w })
                  }
                />
                <span>{w}</span>
              </label>
          ...
          <div className="text-sm">
            7) การลงนามในสัญญาห้ามเปิดเผยข้อมูล (Confidentiality Agreement)
          </div>
          <div className="col-span-3 flex gap-4">
            {["ไม่มี", "มี"].map((w) => (
              <label key={w} className="flex items-center gap-2">
            ...
            {[
              ...
              <label key={v} className="flex items-center gap-2">
                <input
                  ...
                  onChange={() =>
                    setFormData({ ...formData, teacher_visit: v })
                  }
                />
                <span>{t}</span>
              </label>
        ...
        <div className="space-y-2 pt-6">
          ...
          <div className="border rounded-md overflow-hidden mt-2">
            <div className="p-2 bg-slate-100 font-medium">
              2.1 ความคิดเห็นของนิสิต/นักศึกษาก่อนแหล่งฝึก
              (พิจารณาจากการสัมภาษณ์หรือการสังเกต) โดยมีเกณฑ์ดังนี้ 4 = ดีมาก, 3
              = ดี, 2 = พอใช้, 1 = ควรปรับปรุง, 0 = ประเมินไม่ได้
            </div>
        ...
        <div className="space-y-4 pt-6">
          ...
          <div className="space-y-3">
            <div className="font-medium">
              3.2 กิจกรรมการฝึกปฏิบัติงานและการประเมินผล
            </div>
                ...
                {[
                  ...
                  <label key={v} className="flex items-center gap-2">
                    <input
                      ...
                      onChange={() =>
                        setFormData({ ...formData, s322_mode: v })
                      }
                    />
                ...
                {[
                  ...
                  <label key={v} className="flex items-center gap-2">
                    <input
                      ...
                      onChange={() =>
                        setFormData({ ...formData, s323_duration: v })
                      }
                    />
                    <span className="text-sm">{t}</span>
                  </label>
            ...
            <div>
              <div className="text-sm mb-1">
                3.2.4
                หัวข้อและรูปแบบการประเมินผลตามคู่มือการฝึกปฏิบัติงานเหมาะสมหรือไม่
              </div>
          ...
          <div className="space-y-3">
            ...
            {[
              ...
              [
                "c_brief",
                "การนัดหมายแหล่งฝึกและการชี้แจงรายละเอียดการฝึกปฏิบัติงานวิชาชีพ",
              ],
              [
                "c_list",
                "การแจ้งรายชื่อนิสิต/นักศึกษาฝึกงาน (โดยผู้ประสานงานโซน)",
              ],
              [
                "c_register",
                "การยืนยันการฝึกงานของนิสิต/นักศึกษาของแต่ละมหาวิทยาลัย",
              ],
              [
                "c_travel",
                "การประสานงานทั่วไปเกี่ยวกับการเดินทางของนิสิต/นักศึกษา และที่พัก",
              ],
              [
                "c_issue",
                "การประสานงานในกรณีที่เกิดปัญหาในระหว่างการฝึกปฏิบัติงาน",
              ],
              ...
              <div key={k} className="grid md:grid-cols-5 gap-2 items-center">
                ...
                <label className="flex items-center gap-2">
                  <input
                    ...
                    onChange={() =>
                      setFormData({ ...formData, [k]: "เหมาะสม" })
                    }
                  />
                ...
                <label className="flex items-center gap-2">
                  <input
                    ...
                    onChange={() =>
                      setFormData({ ...formData, [k]: "ควรปรับปรุง" })
                    }
                  />
